...
<head>
	...
	<script>
		...
		‘https://connect.facebook.net/en_US/fbevents.js’);
				fbq(‘init’, ‘265281351854354’);
		fbq(‘track’, ‘PageView’);
	</script>
	<noscript><img height=“1” width=“1" style=“display:none”
				   src=“https://www.facebook.com/tr?id=265281351854354&ev=PageView&noscript=1”
		/></noscript>
	...
	<section class="logo-header">
		<div class="container">
			<div class="row ">
				...
				<div class="col-lg-3 col-sm-6 col-7 order-lg-last">
	...
	<div class="mainmenu-area mainmenu-bb">
		<div class="container">
			<div class="row align-items-center mainmenu-area-innner">
				<div class="col-lg-3 col-md-6 categorimenu-wrapper">
				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper">
					<nav hidden>
			...
			<div class="row">
				<div class="col-md-6 col-lg-4">
					<div class="footer-info-area">
						...
						<div class="text">
						<p><span>Phone: </span> <a href="tel:+9221111244266">+92 21 111-244-266</a> </p>
                        <p><span>Email: </span> <a href="mailto:orders@huf.com">orders@huf.com</a> </p>
						</div>
					</div>
